...
static const sppctlgrp_t sp7350grps_uart4[] = {
	EGRP("UART4", 1, pins_uart4)
};

static const unsigned pins_uadbg[] = { 46, 47 };
static const sppctlgrp_t sp7350grps_uadbg[] = {
