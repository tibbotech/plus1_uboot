...
static const sp7021grp_t sp7021grps_snand[] = {
...
static const sp7021grp_t sp7021grps_u2otg[] = {
...
static const sp7021grp_t sp7021grps_wakeup0[] = {
	EGRP("WAKEUP0", 1, pins_wakeup0)
};

static const unsigned pins_wakeup1[] = { 73 };
static const sp7021grp_t sp7021grps_wakeup1[] = {
...
static const sp7021grp_t sp7021grps_int0[] = {
...
static const sp7021grp_t sp7021grps_int1[] = {
...
static const sp7021grp_t sp7021grps_int2[] = {
...
static const sp7021grp_t sp7021grps_int3[] = {
...
static const sp7021grp_t sp7021grps_int4[] = {
...
static const sp7021grp_t sp7021grps_int5[] = {
...
static const sp7021grp_t sp7021grps_int6[] = {
...
static const sp7021grp_t sp7021grps_int7[] = {
...
func_t list_funcs[] = {
	FNCE("SPI_FLASH",       fOFF_G, 1, 0, 1, sp7021grps_spif),
	FNCE("CARD0_EMMC",      fOFF_G, 1, 1, 1, sp7021grps_emmc),
	FNCE("SPI_NAND",        fOFF_G, 1, 2, 1, sp7021grps_snand),
	FNCE("SD_CARD",         fOFF_G, 1, 3, 1, sp7021grps_sdc30),
	FNCE("SDIO",            fOFF_G, 1, 4, 1, sp7021grps_sdio30),
	FNCE("UART0",           fOFF_G, 1, 5, 1, sp7021grps_uart0),
	FNCE("UART1",           fOFF_G, 1, 6, 1, sp7021grps_uart1),
	FNCE("UART2",           fOFF_G, 1, 9, 1, sp7021grps_uart2),  // TO BE CONFIRMED
	FNCE("UART3",           fOFF_G, 1,10, 1, sp7021grps_uart3),  // TO BE CONFIRMED

	FNCE("INT0",            fOFF_G, 2, 0, 3, sp7021grps_int0),
	FNCE("INT1",            fOFF_G, 2, 3, 3, sp7021grps_int1),
	FNCE("INT2",            fOFF_G, 2, 6, 3, sp7021grps_int2),
	FNCE("INT3",            fOFF_G, 2, 9, 3, sp7021grps_int3),
	FNCE("INT4",            fOFF_G, 2,12, 3, sp7021grps_int4),
	FNCE("INT5",            fOFF_G, 3, 0, 3, sp7021grps_int5),
	FNCE("INT6",            fOFF_G, 3, 3, 3, sp7021grps_int6),
	FNCE("INT7",            fOFF_G, 3, 6, 3, sp7021grps_int7),

	FNCE("SPI_MASTER0",     fOFF_G, 2,15, 1, sp7021grps_spim0),  // TO BE CONFIRMED
	FNCE("SPI_SLAVE0",      fOFF_G, 2,15, 1, sp7021grps_spis0),  // TO BE CONFIRMED
	FNCE("USB2_OTG",        fOFF_G, 2,15, 1, sp7021grps_u2otg),  // TO BE CONFIRMED
	FNCE("I2C_MASTER0",     fOFF_G, 2,15, 1, sp7021grps_i2cm0),  // TO BE CONFIRMED
	FNCE("WAKEUP0",         fOFF_G, 2,15, 1, sp7021grps_wakeup0),  // TO BE CONFIRMED
	FNCE("WAKEUP1",         fOFF_G, 2,15, 1, sp7021grps_wakeup1)   // TO BE CONFIRMED
};
