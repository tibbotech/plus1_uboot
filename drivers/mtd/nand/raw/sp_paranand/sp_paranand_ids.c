...
const struct nand_flash_dev sp_pnand_ids[] = {
	...
	*/
	NAND_ID("Samsung K9F2G08XXX ZEBU", 0xec, 0xd7, SZ_2K, SZ_64, SZ_128K, SZ_256, 2, 512),
	NAND_ID("GigaDevice 9AU4G8F3AMGI", 0xc8, 0xdc, SZ_2K, SZ_64, SZ_128K, SZ_512, 2, 512),
	//NAND_ID("Samsung K9GBG08U0B", 0xec, 0xd7, SZ_2K, SZ_64, SZ_128K, SZ_256, 2, 512),
	//NAND_ID("GD9FU4G8F4BMGI", 0xc8, 0xdc, SZ_4K, SZ_256, SZ_256K, SZ_512, 2, 512),
	{NULL},
};
#endif
