...
EDDSA_DECL void ed25519_hash(const uint8_t sig[ED25519_SIG_LEN], const uint8_t *data, size_t len,
			       const uint8_t pub[ED25519_KEY_LEN], uint8_t h[64]);

EDDSA_DECL bool	ed25519_verify_hash(const uint8_t sig[ED25519_SIG_LEN],
			       const uint8_t pub[ED25519_KEY_LEN],
			       const uint8_t hval[ED25519_SIG_LEN]);
