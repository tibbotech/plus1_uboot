...
#define MTDPARTS_DEFAULT		"sp_spinand.0:128k(nand_header),384k(xboot1),1536k(uboot1),2048k(uboot2),512k(env),512k(env_redund),1m(reserve),256k(dtb),25m(kernel),33536k(rootfs)"
#else
